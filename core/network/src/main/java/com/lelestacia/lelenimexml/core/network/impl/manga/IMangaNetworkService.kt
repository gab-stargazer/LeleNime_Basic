...
interface IMangaNetworkService {
    ...
    suspend fun getMangaRecommendationByMangaID(mangaID: Int): List<MangaResponse>
    suspend fun searchMangaByTitle(title: String, sfw: Boolean): PagingSource<Int, MangaResponse>
}